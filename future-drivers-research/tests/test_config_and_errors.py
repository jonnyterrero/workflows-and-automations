...
class TestDotenvLoading:
    def test_values_are_loaded_into_the_environment(self, tmp_path, monkeypatch):
    ...
    def test_override_forces_the_file_value(self, tmp_path, monkeypatch):
        env_file = tmp_path / ".env"
        env_file.write_text("FDR_TEST_KEY=from-file\n")
        monkeypatch.setenv("FDR_TEST_KEY", "from-shell")
    ...
    def test_values_containing_equals_are_preserved(self, tmp_path, monkeypatch):
    ...
    def test_missing_file_is_not_an_error(self, tmp_path):
        config.load_dotenv(tmp_path / "nonexistent.env")
